...
public class DonneesHistoTest {
    ...
    */
    ...
    public void testGetLatitudeGPS() throws Exception {
        ...
        Connection con = ConnexionMySQL.newConnexion();
        DonneesHisto instance = DonneesHisto.getByDatation(con, "2018-01-03 17:42:37");
        float result = instance.getLatitudeGPS();
        NumberFormat latitude = NumberFormat.getInstance();
 
        latitude.setMaximumFractionDigits(5);
 
        System.out.println(latitude.format(result));
        assertEquals(40.5643453, result, 0.00001);
    }
    ...
    public void testGetLongitudeGPS() throws Exception {
        ...
        Connection con = ConnexionMySQL.newConnexion();
        DonneesHisto instance = DonneesHisto.getByDatation(con, "2018-01-03 17:42:37");
        assertEquals(50.6354734, instance.getLongitudeGPS(), 0.00001);
    }
